...
{
    internal class Page_Compress : Plugin.Page
    {
        ...
        {
            label_introduction = CreateText(MAUIStr.Obj.Compress_Introduction);
        ...
        {
            l1 = CreateTitle(MAUIStr.Obj.Compress_Mode1);
            l2 = CreateTitle(MAUIStr.Obj.Compress_Mode2);
            s = CreateSwitch();
            HBox ans = new HBox();
