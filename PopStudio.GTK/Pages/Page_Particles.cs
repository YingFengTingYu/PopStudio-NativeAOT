...
{
    internal class Page_Particles : Plugin.Page
    {
        ...
        public Page_Particles()
        {
            ...
            text_out = CreateTitle(MAUIStr.Obj.Particles_OutFormat);
