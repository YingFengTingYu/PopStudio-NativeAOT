...
{
    internal class Page_RTON : Plugin.Page
    {
        ...
        public Page_RTON()
        {
            label_introduction = CreateText(MAUIStr.Obj.RTON_Introduction);
        ...
        {
            l1 = CreateTitle(MAUIStr.Obj.RTON_Mode1);
            l2 = CreateTitle(MAUIStr.Obj.RTON_Mode2);
            s = CreateSwitch();
            HBox ans = new HBox();
