...
{
    internal class Page_Reanim : Plugin.Page
    {
        ...
        public Page_Reanim()
        {
            ...
            text_out = CreateTitle(MAUIStr.Obj.Reanim_OutFormat);
            CB_OutMode = CreateComboBox(7, "PC_Compiled", "Phone32_Compiled", "Phone64_Compiled", "WP_Xnb", "GameConsole_Compiled", "TV_Compiled", "Studio_Json", "Raw_Xml", "Flash_Xfl_Folder");
